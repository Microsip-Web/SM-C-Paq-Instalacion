let Data = {
	Pack2022: [
		{
			...
			packTitle: 'Microsip',
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/Microsip/2022.html',
		},

		{
			...
			packTitle: 'CEO Móvil',
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/CEO/index.html',
		},

		{
			...
			packTitle: 'Sync-e',
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/Sync/index.html',
		},

		{
			...
			packTitle: 'En Ruta',
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/MER/index.html',
		},

		{
			...
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/SiCS/matriz.html',
		},

		{
			...
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/SiCS/sucursal.html',
		},

		{
			...
			packTitle: 'API',
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/api/api.html',
		},

		{
			...
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/SA/index.html',
		},

		{
			...
			frame:
				'https://dor1k8lp3ljt2.cloudfront.net/DescargasSoporte/RA/index.html',
		},
	],
	...
	Pack2021: [
		{
			...
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Microsip/Instalar2021.zip',
			updated: '2022-03-11',
			size: '513 MB',
		},

		{
			...
			packTitle: 'CEO Móvil',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/CEO/CEO_2021.zip',
			updated: '2022-03-08',
		},

		{
			...
			packTitle: 'Sync-e',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Sync/Sync_2021.zip',
			updated: '2022-02-22',
		},

		{
			...
			packTitle: 'En Ruta',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MER/MER_2021.zip',
			updated: '2022-02-22',
		},

		{
			...
			packTitle: 'SICS – Agente Matriz',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/SiCS/SiCS_agente_matriz_2021.zip',
			updated: '2022-02-22',
		},
...

		{
			packYear: '2021',
			packImg:
				'https://uploads-ssl.webflow.com/62ebdd458759bdb749120f22/6307a43912000fda3bdab898_Group%20169.png',
...

		{
			...
			packTitle: 'API',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/api/ApiMicrosip2021.zip',
			updated: '2022-02-22',
		},

		{
			...
			packTitle: 'Servidor de Aplicaciones',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/SA/SA_2021.zip',
			updated: '2022-10-04',
		},

		{
			...
			packTitle: 'Respaldos Automáticos',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/RA/RA_2021.zip',
			updated: '2022-02-22',
		},
	],
	...
	Pack2020: [
		{
			...
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Microsip/Instalar2020.zip',
			updated: '2021-04-22',
			size: '489 MB',
		},

		{
			...
			packTitle: 'CEO Móvil',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/CEO/CEO_2020.zip',
			updated: '2021-03-26',
		},

		{
			...
			packTitle: 'Sync-e',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Sync/Zinc_2020.zip',
			updated: '2021-04-08',
		},

		{
			...
			packTitle: 'En Ruta',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MER/MER_2020.zip',
			updated: '2021-01-26',
		},
...

		{
			...
			packTitle: 'Respaldos Automáticos',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/RA/RA_2020.zip',
			updated: '2021-01-26',
		},

		{
			...
			packTitle: 'API',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/api/ApiMicrosip2020.zip',
			updated: '2020-12-07',
		},
	],
	...
	Pack2019: [
		{
			...
			packTitle: 'Microsip',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Microsip/Instalar2019.zip',
			updated: '2020-03-10',
			size: '470 MB',
		},

		{
			...
			packTitle: 'CEO Móvil',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/CEO/CEO_2019.zip',
			updated: '2019-10-11',
		},

		{
			...
			packTitle: 'Sync-e',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Sync/Zinc_2019.zip',
			updated: '2019-10-11',
		},

		{
			...
			packTitle: 'En Ruta',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MER/MER_2019.zip',
			updated: '2019-10-11',
		},
		...
		// !no S3 link for this one/////////////////
		{
			...
			packTitle: 'Respaldos Automáticos',
			downloadLink:
				'https://soporte.microsip.com/archivos/utiING/InstalarRespaldosAutomaticos_191011.zip',
			updated: '2019-10-11',
		},
		// !no S3 link for this one/////////////////
		{
			packYear: '2019',
			packImg:
				'https://uploads-ssl.webflow.com/62ebdd458759bdb749120f22/6307bc8c2e14931cf0e3cb8f_assignment_white_24dp%201.png',
			packTitle: 'Guía de instalación',
			downloadLink:
...

		{
			...
			packTitle: 'API',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/api/ApiMicrosip2019.zip',
			updated: '2019-08-20',
		},

		{
			...
			packTitle: 'ConvertDB',
			downloadLink:
				'https://s3.us-west-2.amazonaws.com/descargassoportemsp/Microsip/convertir-bd-2019.zip',
			size: '15.0 MB',
		},
	...
	PackLegado: [
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2015.zip',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2014.rar',
				Parte1:
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2012.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2010.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2009.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2008.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2006.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...

		{
			...
			downloadLink: {
				Completa:
					'https://s3.us-west-2.amazonaws.com/descargassoportemsp/MicrosipLegacy/instalar-2005.rar',
				Parte1: '',
				Parte2: '',
				Parte3: '',
			},
...
// note Get selected value from select element
/**
...
// note fires getSelectedValue function and display content
/**
 * When the user selects a value from the dropdown, display the corresponding pack.
 */

// display content based on the selected value
...
/**
 * It takes the data from the JSON file and displays it on the page.
 */
